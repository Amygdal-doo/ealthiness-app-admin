...
export const InviteCompanyDoctorModal: React.FC<
  InviteCompanyDoctorModalProps
> = ({ isOpen, onClose, companyId, companyName }) => {
  ...
  const inviteMutation = useInviteDoctorToCompany();
  ...
  const adminDoctorsQuery = useDoctors(
    {
      page: currentPage,
      limit: PAGE_SIZE,
  ...
  const companyDoctorsQuery = useCompanyDoctors(
    companyId,
    {
      page: currentPage,
      limit: PAGE_SIZE,
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = isCompanyAdmin ? companyDoctorsQuery : adminDoctorsQuery;
  ...
  const handleInvite = async () => {
    ...
    try {
      ...
      console.error("Failed to invite doctor to company:", error);
      setErrorMessage(
        getApiErrorMessage(
          error,
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <Button
              ...
              disabled={inviteMutation.isPending || !selectedDoctor}
