...
import type { Route } from "./+types/country.$id.companies";
import {
  Building2,
  Plus,
  Mail,
...
import { useCountryCompanies, useCountryDetails } from "~/hooks/useAuthApi";
...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Country Companies - Ealthiness Admin Portal" },
    {
      name: "description",
      content: "Manage companies in the country",
    },
  ];
}
...
export default function CountryCompaniesPage({
  loaderData,
}: {
  ...
  // Fetch country companies with React Query
  const {
    data: companiesResponse,
    isLoading,
    error,
    refetch,
  } = useCountryCompanies(actualCountryId, {
    page: currentPage,
    limit: 10,
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[#60646C] text-sm font-medium mt-1">
                    {companiesResponse
                      ? `Total ${companiesResponse.total} companies in this country.`
                      : `Total ${visibleCompanies.length} companies in this country.`}
                  </p>
                </div>
              </div>
                            ...
                            {isLoading
                              ...
                              : error
                                ...
                                : searchTerm
                                  ...
                                  : "No companies found in this country"}
                          </td>
                        </tr>
                      )}
                    </tbody>
