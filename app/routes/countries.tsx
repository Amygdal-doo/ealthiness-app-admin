    ...
    <Layout role={role} title="Regions & Countries">
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-extrabold text-[#1B173A]">Regions & Countries</h2>
            <p className="text-[#60646C] text-sm font-medium mt-1">Manage country-level administrators and health stats.</p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead className="bg-[#F8F9FB] border-b border-[#E0E1E6]">
                <tr>
                  <th className="p-4 text-xs font-bold text-[#8E8E93] uppercase tracking-widest">Region / Country</th>
                  <th className="p-4 text-xs font-bold text-[#8E8E93] uppercase tracking-widest">Code</th>
                  <th className="p-4 text-xs font-bold text-[#8E8E93] uppercase tracking-widest">Admins</th>
              ...
              <tbody className="divide-y divide-[#E0E1E6]">
                {userData.countries.map(country => (
                  <tr key={country.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="p-4 font-mono text-[#60646C] text-sm">{country.code}</td>
                    <td className="p-4">
            ...
            <Card className="w-full max-w-md shadow-2xl animate-in zoom-in-95 duration-200">
              ...
              <div className="p-6 space-y-4">
                ...
                {modalState.type === 'country' && (
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-[#8E8E93] uppercase">Region Name</label>
                    <input 
                      className="w-full px-3 py-2 border border-[#E0E1E6] rounded-lg focus:border-[#5850DE] outline-none"
